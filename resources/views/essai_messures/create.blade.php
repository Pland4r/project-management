...
<div class="container py-4">
    ...
    <nav class="breadcrumb-nav mb-3 fade-in">
        ...
        <span>/</span>
        <a href="{{ route('projects.show', $project->id) }}" class="breadcrumb-link">
            {{ $project->project_name }}
        </a>
        <span>/</span>
        <span class="breadcrumb-current">Create Essai/Messure</span>
    </nav>
    ...
    <div class="page-header slide-up">
        <div class="header-left">
            ...
            <div class="header-info">
                <h1 class="page-title">Create New Essai/Messure</h1>
                <p class="page-subtitle">for {{ $project->project_name }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="form-card slide-up delay-1">
        <form action="{{ route('essai_messures.store', $project->id) }}" method="POST" class="compact-form">
            @csrf
                ...
                <div class="form-grid">
                    <div class="form-group animated-input">
                        ...
                        <select name="type" id="type" class="form-control hover-input" required>
                            ...
                            <option value="messure">Messure</option>
                        </select>
                    ...
                    <div class="form-group animated-input">
                        <label for="etat">Initial Status</label>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group animated-input">
                        ...
                        <input type="text" name="validator_name" id="validator_name" class="form-control hover-input" 
                               placeholder="Who will validate this?">
                        <div class="input-glow"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group animated-input">
                        ...
                        <textarea name="issues" id="issues" class="form-control hover-input" rows="3" 
                                  placeholder="Describe any known issues..."></textarea>
                        <div class="input-glow"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success hover-lift">
                    <i class="fas fa-plus-circle"></i> 
                    <span>Créer Essai/Messure</span>
                    <div class="btn-shine"></div>
                    <div class="btn-ripple"></div>
                </button>
                <a href="{{ route('projects.show', $project->id) }}" class="btn btn-secondary hover-lift">
...
<style>
/* Enhanced Create Form Animations - Same as Edit */
.container {
    max-width: 900px;
}
